...
//
///**
// * Helper methods related to requesting earthquake data from USGS.
// */
//
...
//     * directly from the class name QueryUtils (and and object instance of QueryUtils is not needed).
//     */
//
//    private QueryUtils (){
//    }
//
//    /**
//     * Return a list of {@link Football} objects that has been built up from parsing
//     * a JSON response.
//     */
//
//    public static ArrayList<Football> extractFootballNews() {
//
...
//        //Catch teh exception so the app doesn't crash, and print the error message to the logs.
//        try {
//
...
//            JSONArray footballArray = baseJsonResponse.getJSONArray("features");
//
//            // For each earthquake in the earthquakeArray, create an {@link Earthquake} object
//            for( int i = 0; i < footballArray.length(); i++) {
//                JSONObject currentFootball = footballArray.getJSONObject(i);
//                JSONObject properties = currentFootball.getJSONObject("properties");
//
...
//                Football football = new Football(magnitude, location, time, url);
//                footballs.add(football);
//            }
//
//        } catch (JSONException e) {
//
//            // If and error is thrown when executing any of the above statements in the "try" block,
