...
public class QueryUtils {
    ...
    /**
     * Query the Guardian dataset and return a list of {@link Football}
     */
    ...
    private static String makeHttpRequest(URL url) throws IOException {
         ...
         * parsing the give JSON response.
         */
        ...
        private static List<Football> extractFeatureFromJson (String footballJSON){
            ...
            try {
                ...
                for (int i = 0; i < newsArray.length(); i++) {
                    ...
                    // Create a new {@link News} object with the type, section, date,
                    // title, url from the JSON response.
                ...
                // If an error is thrown when executing any fo the above statements in the "try" block,
